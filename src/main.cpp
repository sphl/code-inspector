...
#include <code_inspector/inspection.h>
#include <code_inspector/pretty_printer.h>
#include <iostream>
...
int main(int argc, char **argv) {
    llvm::cl::ParseCommandLineOptions(argc, argv, "Code Inspector\n");
    ...
    try {
        JSONPrinter printer;
        Inspector inspector(inputFile.getValue());
