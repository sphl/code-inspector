...
#ifndef CODE_INSPECTOR_INSPECTOR_H
#define CODE_INSPECTOR_INSPECTOR_H
...
class MissingDebugInfoException : public std::exception {
  ...
  public:
    ...
    explicit MissingDebugInfoException(std::string message) : message(std::move(message)) {}
...
class Inspector {
  ...
  public:
     ...
     */
    std::vector<code_inspector::FuncInfo> getFuncInfos();
     ...
     */
    std::map<code_inspector::BBId, std::set<code_inspector::BBId>> getICFGInfos();
};

}  // namespace code_inspector

#endif  // CODE_INSPECTOR_INSPECTOR_H
